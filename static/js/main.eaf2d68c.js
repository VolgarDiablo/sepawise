...
class ErrorBoundary extends react.Component{constructor(props){super(props);this.state={hasError:false};}static getDerivedStateFromError(error){return{hasError:true};}componentDidCatch(error,errorInfo){console.error("Error Boundary caught an error:",error,errorInfo);}render(){if(this.state.hasError){return/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{children:"\u0427\u0442\u043E-\u0442\u043E \u043F\u043E\u0448\u043B\u043E \u043D\u0435 \u0442\u0430\u043A. \u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435."});}return this.props.children;}}/* harmony default export */ const src_ErrorBoundary = (ErrorBoundary);
...
/* harmony default export */ const tetherTRC = (__webpack_require__.p + "static/media/tetherTRC.f81f7a26a94c538b9dea7dc77f26e56e.svg");

;// ./src/pages/Main/Main.js
const schema=z.object({email:z.string().email("Wrong e-mail format").min(1,"Enter email"),wallet:z.string().regex(/^T[0-9A-HJ-NP-Za-km-z]{33}$/,"Wrong Tether TRC-20 address format").min(1,"You must fill in this field")});const Main=()=>{const[selectedButtonBlockSell,setSelectedButtonBlockSell]=(0,react.useState)("All");const[selectedButtonBlockBuy,setSelectedButtonBlockBuy]=(0,react.useState)("All");const handleClickBlockSell=button=>{setSelectedButtonBlockSell(button);};const handleClickBlockBuy=button=>{setSelectedButtonBlockBuy(button);};const[formData,setFormData]=(0,react.useState)({email:"",wallet:""});const[errors,setErrors]=(0,react.useState)({});const handleChange=e=>{const{name,value}=e.target;setFormData({...formData,[name]:value});// Очистка ошибки для текущего поля при изменении
setErrors(prevErrors=>({...prevErrors,[name]:undefined}));};const handleSubmit=e=>{e.preventDefault();try{schema.parse(formData);alert("Form submitted successfully!");setErrors({});}catch(err){const newErrors={};err.errors.forEach(error=>{newErrors[error.path[0]]=error.message;});setErrors(newErrors);}};const handleBlur=e=>{const{name}=e.target;try{schema.pick({[name]:true}).parse({[name]:formData[name]});// Если валидация успешна, очищаем ошибку
setErrors(prevErrors=>({...prevErrors,[name]:""}));}catch(err){// Если есть ошибки, извлекаем их корректно
...
const Content=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(src_ErrorBoundary,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Routes,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Main_Main,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"*",element:/*#__PURE__*/(0,jsx_runtime.jsx)(NotFound_NotFound,{})})]})})});};/* harmony default export */ const Content_Content = (Content);
...
/******/ })()
;
//# sourceMappingURL=main.eaf2d68c.js.map